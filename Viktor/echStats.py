...
COLLECTION_IDS = [
    os.getenv('SEASON_MATCHES_ECH20_21'),
    os.getenv('SEASON_MATCHES_ECH21_22'),  
    os.getenv('SEASON_MATCHES_ECH22_23'),
    os.getenv('SEASON_MATCHES_ECH23_24'),
    os.getenv('SEASON_MATCHES_ECH24_25'),  
]

OUTPUT_FILENAME = "all_ech_data.xlsx"
