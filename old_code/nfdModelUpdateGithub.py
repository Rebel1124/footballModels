...
DATABASE_ID = os.environ.get('APPWRITE_DB_ID')

MODEL_DATABASE_ID = os.environ.get('APPWRITE_MODEL_DB_ID')
NFD_MODEL_COLLECTION_ID = os.environ.get('NFD_MODEL_COLLECTION_ID')

# List of collection IDs to retrieve data from
COLLECTION_IDS = [
    # os.environ.get('SEASON_MATCHES_NFD20_21'),
    # os.environ.get('SEASON_MATCHES_NFD21_22'),  
    # os.environ.get('SEASON_MATCHES_NFD22_23'),
    # os.environ.get('SEASON_MATCHES_NFD23_24'),
    os.environ.get('SEASON_MATCHES_NFD24_25'),  
]
...
def update_database(dataframe):
    ...
    print("Fetching existing documents from Appwrite...")
    try:
        existing_docs = {}
        ...
        while True:
            ...
            print(f"Fetched {total_docs} documents so far...")
        ...
        if to_create:
            print(f"Creating {len(to_create)} new documents...")
            for i in range(0, len(to_create), BATCH_SIZE):
                batch = to_create[i:i+BATCH_SIZE]
                print(f"Creating batch {i//BATCH_SIZE + 1}/{(len(to_create)-1)//BATCH_SIZE + 1}...")
            ...
            print("No new documents to create.")
        
        # Update existing documents
        if to_update:
            print(f"Updating {len(to_update)} existing documents...")
