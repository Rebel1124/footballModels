...
OUTPUT_FILENAME = "nfd_data_appwrite.xlsx"
...
def save_to_appwrite_storage(dataframe, bucket_id, file_id="nfdStatsAllModels", client=None, appwrite_endpoint=None, project_id=None, api_key=None):
    """
...
save_to_appwrite_storage(df_massey, STORAGE_ID, file_id="nfdStatsAllModels", client=client, 
